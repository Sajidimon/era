<template>
    <section class="">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div
                class="w-full flex-col justify-start items-center lg:gap-16 gap-10 inline-flex lg:pt-[70px] pt-12 lg:pb-28 pb-12"
            >
                <div
                    class="border border-indigo-300 h-[550px] rounded-lg w-full"
                >
                    <div
                        class="p-8 flex justify-between items-center border-b border-indigo-100"
                    >
                        <div class="block">
                            <svg
                                width="204"
                    ...
                    <div
                        class="relative h-[calc(550px-85px)] flex justify-center items-center flex-col"
                    >
                        <svg
                            width="314"
                            height="171"
                        ...
                        <div class="block text-center mt-5">
                            <h5
                                class="md:text-xl text-lg leading-8 text-gray-900 font-medium mb-1.5"
                            >
                            ...
                            <p class="text-sm text-gray-500">
                                Visit <Link href="/" class="text-blue-500 font-bold">Home</Link>
                            </p>
                        </div>
                    </div>
                </div>
