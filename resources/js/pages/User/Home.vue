<template>
    ...
    <div v-else class="">
        <nav
            class="py-5 border-b-default border-solid border-gray-200 z-10 w-full bg-inherit lg:sticky"
            id="topnav"
        >
            <div class="mx-auto max-w-7xl lg:px-8">
                <div class="w-full flex flex-col lg:flex-row">
                    ...
                    >
                        ...
                        <h2 class="hidden lg:flex items-center text-2xl">
                            Era Builder
                        </h2>
                        <div
        ...
        >
            <div
                class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative text-center"
            >
                <h1
                    class="max-w-2xl mx-auto text-center font-manrope font-bold text-4xl text-gray-900 mb-5 md:text-5xl leading-[50px]"
                >
                    Easy to setup & Customizable
                    <span class="text-indigo-600">Sales Funnel Builder</span>
                </h1>
                <p
                    class="max-w-sm mx-auto text-center text-base font-normal leading-7 text-gray-500 mb-9"
                >
                    Reduce your cost intelligently and use this better way to
                    manage your entire Ecommerce solution.
                </p>
                <Link
                    href="/register"
                ...
                <div class="flex justify-center">
                    <img
                        src="https://community.sap.com/legacyfs/online/storage/blog_attachments/2018/03/BlogBanner.jpg"
                        alt="Dashboard image"
